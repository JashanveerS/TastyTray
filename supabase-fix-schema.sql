...
CREATE TRIGGER handle_updated_at_pantry BEFORE UPDATE ON public.pantry_items
  FOR EACH ROW EXECUTE PROCEDURE public.handle_updated_at();

CREATE TRIGGER handle_updated_at_shopping BEFORE UPDATE ON public.shopping_list
  FOR EACH ROW EXECUTE PROCEDURE public.handle_updated_at();
